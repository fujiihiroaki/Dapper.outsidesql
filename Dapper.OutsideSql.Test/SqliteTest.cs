...
using SQLiteConnection2 = Microsoft.Data.Sqlite.SqliteConnection;
...
public class SqliteTest
{
    ...
    public void TestSetup()
    {
        ...
        {
            DataSource = "C:\\Temp\\S2DOTNETDEMO.db",
            Cache = SqliteCacheMode.Private,
            Mode = SqliteOpenMode.ReadWrite
        };
        _connectionString = builder.ConnectionString;
        
        Logger.Category = "Dapper.OutsideSql.Test.SqliteTest";
        Logger.Factory.AddProvider(new NLogLoggerProvider());
        Logger.Factory.AddProvider(new DebugLoggerProvider());
        
        _logger = Logger.CreateLogger<SqlServerTest>();
    }
    ...
    [TestMethod]
    public void TestSelect1_ForSystemData()
    {
        var filePath = FILE_LOCATION + DS + @"Select1Test.sql";
        using (var conn = new SQLiteConnection1(_connectionString))
        {
            conn.Open();
    ...
    [TestMethod]
    public void TestSelect1_ForMicrosoftData()
    {
        var filePath = FILE_LOCATION + DS + @"Select1Test.sql";
        using (var conn = new SQLiteConnection2(_connectionString))
        {
            conn.Open();
            _logger.LogDebug("--- Start File Test ---");
            var list = conn.QueryOutsideSql<Test1>(filePath, new {sarary = 1500});
    ...
    [TestMethod]
    public void TestSelect2_ForSystemData()
    {
    ...
    [TestMethod]
    public void TestSelect2_ForMicrosoftData()
    {
        var filePath = FILE_LOCATION + DS + @"Select2Test.sql";
        using (var conn = new SQLiteConnection2(_connectionString))
        {
    ...
    [TestMethod]
    public void TestSelect3_ForSystemData()
    {
        using (var conn = new SQLiteConnection1(_connectionString))
        {
            conn.Open();
    ...
    [TestMethod]
    public void TestSelect3_ForMicrosoftData()
    {
        using (var conn = new SQLiteConnection2(_connectionString))
        {
            conn.Open();
    ...
    [TestMethod]
    public void TestCrud_ForSystemData()
    {
    ...
    [TestMethod]
    public void TestCrud_ForMicrosoftData()
    {
        var filePath = FILE_LOCATION + DS + @"Crud1Test.sql";
        using (var conn = new SQLiteConnection2(_connectionString))
        {
    ...
    [TestMethod]
    public void TestCrud2_ForSystemData()
    {
    ...
    [TestMethod]
    public void TestCrud2_ForMicrosoftData()
    {
        var filePath = FILE_LOCATION + DS + @"Crud2Test.sql";
        using (var conn = new SQLiteConnection2(_connectionString))
        {
    ...
    [TestMethod]
    public void TestCrud3_ForSystemData()
    {
    ...
    [TestMethod]
    public void TestCrud3_ForMicrosoftData()
    {
        var filePath = FILE_LOCATION + DS + @"Crud3Test.sql";
        using (var conn = new SQLiteConnection2(_connectionString))
        {
    ...
    [TestMethod]
    public void TestExecuteMultiNoResults_ForSystemData()
    {
        using (var conn = new SQLiteConnection1(_connectionString))
        {
            conn.Open();
    ...
    [TestMethod]
    public void TestExecuteMultiNoResults_ForMicrosoftData()
    {
        using (var conn = new SQLiteConnection2(_connectionString))
        {
            conn.Open();
    ...
    [TestMethod]
    public async Task TestSelectAsync1_ForSystemData()
    {
        var filePath = FILE_LOCATION + DS + @"Select1Test.sql";
        await using (var conn = new SQLiteConnection1(_connectionString))
        {
            conn.Open();
            _logger.LogDebug("--- Start File Test ---");
    ...
    [TestMethod]
    public async Task TestSelectAsync1_ForMicrosoftData()
    {
        var filePath = FILE_LOCATION + DS + @"Select1Test.sql";
        await using (var conn = new SQLiteConnection2(_connectionString))
        {
            conn.Open();
            _logger.LogDebug("--- Start File Test ---");
            var list = await conn.QueryOutsideSqlAsync<Test1>(filePath, new {sarary = 1500});
    ...
    [TestMethod]
    public async Task TestSelectAsync2_ForSystemData()
    {
        var filePath = FILE_LOCATION + DS + @"Select2Test.sql";
        await using (var conn = new SQLiteConnection1(_connectionString))
        {
    ...
    [TestMethod]
    public async Task TestSelectAsync2_ForMicrosoftData()
    {
        var filePath = FILE_LOCATION + DS + @"Select2Test.sql";
        await using (var conn = new SQLiteConnection2(_connectionString))
        {
    ...
    [TestMethod]
    public async Task TestSelectAsync3_ForSystemData()
    {
        await using (var conn = new SQLiteConnection1(_connectionString))
        {
            conn.Open();
    ...
    [TestMethod]
    public async Task TestSelectAsync3_ForMicrosoftData()
    {
        await using (var conn = new SQLiteConnection2(_connectionString))
        {
            conn.Open();
    ...
    [TestMethod]
    public async Task TestCrudAsync1_ForSystemData()
    {
        var filePath = FILE_LOCATION + DS + @"Crud1Test.sql";
        await using (var conn = new SQLiteConnection1(_connectionString))
        {
    ...
    [TestMethod]
    public async Task TestCrudAsync1_ForMicrosoftData()
    {
        var filePath = FILE_LOCATION + DS + @"Crud1Test.sql";
        await using (var conn = new SQLiteConnection2(_connectionString))
        {
    ...
    [TestMethod]
    public async Task TestCrudAsync2_ForSystemData()
    {
        var filePath = FILE_LOCATION + DS + @"Crud2Test.sql";
        await using (var conn = new SQLiteConnection1(_connectionString))
        {
    ...
    [TestMethod]
    public async Task TestCrudAsync2_ForMicrosoftData()
    {
        var filePath = FILE_LOCATION + DS + @"Crud2Test.sql";
        await using (var conn = new SQLiteConnection2(_connectionString))
        {
    ...
    [TestMethod]
    public async Task TestCrudAsync3_ForSystemData()
    {
        var filePath = FILE_LOCATION + DS + @"Crud3Test.sql";
        await using (var conn = new SQLiteConnection1(_connectionString))
        {
    ...
    [TestMethod]
    public async Task TestCrudAsync3_ForMicrosoftData()
    {
        var filePath = FILE_LOCATION + DS + @"Crud3Test.sql";
        await using (var conn = new SQLiteConnection2(_connectionString))
        {
    ...
    [TestMethod]
    public async Task TestExecuteMultiNoResultsAsync_ForSystemData()
    {
        var filePath = FILE_LOCATION + DS + @"Crud2Test.sql";
        await using (var conn = new SQLiteConnection1(_connectionString))
        {
    ...
    [TestMethod]
    public async Task TestExecuteMultiNoResultsAsync_ForMicrosoftData()
    {
        var filePath = FILE_LOCATION + DS + @"Crud2Test.sql";
        await using (var conn = new SQLiteConnection2(_connectionString))
        {
